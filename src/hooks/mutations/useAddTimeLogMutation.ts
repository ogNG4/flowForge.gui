...
const path: keyof paths = '/project-task/time-log';
...
export default function useAddTimeLogMutation(options: UseMutationOptions<Response, AxiosError, RequestParams> = {}) {
