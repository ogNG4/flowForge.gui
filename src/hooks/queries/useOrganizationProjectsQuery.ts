...
const path: keyof paths = '/project/{organizationId}';
...
export default function useOrganizationProjectsQuery(
    params: RequestParams,
    options?: UseQueryOptions<Response, AxiosError, Response>
) {
    return useQuery<Response, AxiosError, Response>({
        ...options,
        queryKey: [queryKeys.organizationProjects, params.organizationId],
        queryFn: () => get(params),
    });
}
